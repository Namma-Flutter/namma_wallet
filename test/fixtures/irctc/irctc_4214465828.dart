...
final irctc_4214465828 = <OCRBlock>[
  OCRBlock(
    text: '#',
  ...
  OCRBlock(
    text: '(SL)',
    boundingBox: const Rect.fromLTRB(0, 1960, 100, 1980),
    page: 0,
  ),
  OCRBlock(
    text: 'Quota',
  ...
  OCRBlock(
    text: 'Distance',
    boundingBox: const Rect.fromLTRB(0, 2000, 100, 2020),
    page: 0,
  ),
  OCRBlock(
    text: 'Booking Date',
  ...
  OCRBlock(
    ...
    boundingBox: const Rect.fromLTRB(0, 2040, 100, 2060),
    page: 0,
  ),
  OCRBlock(
    text: '714 KM',
