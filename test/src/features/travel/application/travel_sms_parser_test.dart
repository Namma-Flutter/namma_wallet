...
void main() {
  group('TravelSMSParser', () {
    ...
    group('parseDate', () {
      test('should return null for an invalid date string (FormatException)', () {
        // Arrange
      ...
      test('should return null for a date string with incorrect parts count', () {
        // Arrange
      ...
      test('should return a valid DateTime for a valid date string (DD/MM/YYYY)', () {
        // Arrange
      ...
      test('should return a valid DateTime for a valid date string with single digit month/day', () {
        // Arrange
