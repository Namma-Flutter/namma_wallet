...
import 'package:namma_wallet/src/common/services/logger/logger_interface.dart' show ILogger;
...
class GemmaService implements IAIService {
  ...
  Future<List<Ticket>?> parseBatch(List<String> data) async {
